...
function removePluginsNativeFiles(config) {
    ...
    fs_1.removeSync(path_1.join(pluginsPath, 'sourcesstatic'));
    fs_1.removeSync(path_1.join(pluginsPath, 'resources'));
    fs_1.removeSync(path_1.join(pluginsPath, 'noarc'));
}
...
async function getPluginsTask(config) {
    return await common_2.runTask('Updating iOS plugins', async () => {
        ...
        const iosPlugins = await common_1.getIOSPlugins(config, allPlugins);
        return iosPlugins;
    });
}
