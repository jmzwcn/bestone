...
var Item = /** @class */ (function () {
    ...
    Item.prototype.hostData = function () {
        ...
        return {
            ...
            class: Object.assign({}, childStyles, createColorClasses(this.color), (_a = {}, _a["item-lines-" + this.lines] = !!this.lines, _a['item-disabled'] = this.disabled, _a['in-list'] = hostContext('ion-list', this.el), _a['item'] = true, _a['item-multiple-inputs'] = this.multipleInputs, _a))
        };
    };
