...
var ChipButton = /** @class */ (function () {
    ...
    ChipButton.prototype.render = function () {
        ...
        return (h(TagType, { type: "button", class: "button-native", disabled: this.disabled, href: this.href }, h("span", { class: "button-inner" }, h("slot", null)), this.mode === 'md' && h("ion-ripple-effect", null)));
    };
