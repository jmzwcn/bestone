...
var SegmentButton = /** @class */ (function () {
    ...
    SegmentButton.prototype.render = function () {
        var _this = this;
        return [
            h("button", { type: "button", "aria-pressed": this.checked ? 'true' : null, class: "button-native", disabled: this.disabled, onClick: function () { return _this.checked = true; } }, h("slot", null), this.mode === 'md' && h("ion-ripple-effect", null))
        ];
    };
